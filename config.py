...
class Config(object):
    ...
    # database config
    DB_NAME = os.environ.get("DB_NAME", "Anime_UpdatesAU")     
    DB_URL  = os.environ.get("DB_URL", "")
 
    # other configs
    ADMIN_URL = "https://t.me/Mr_Mohammed_29"
    DUMP_CHANNEL = os.environ.get("DUMP_CHANNEL", "-1003783709769")
    DUMP = True
    BOT_UPTIME  = time.time()
    START_PIC   = os.environ.get("START_PIC", "https://graph.org/file/5da2239f78e2467f1df9c-91c72d386238b07ee5.jpg")
    LEADERBOARD_PIC = os.environ.get("LEADERBOARD_PIC", "https://graph.org/file/d724c853cc83da444c7b5-821df256fdead2c9f1.jpg")
    OWNER_ID = int(os.environ.get("OWNER_ID", "7284759394"))
    SUPPORT_CHAT = int(os.environ.get("SUPPORT_CHAT", "-1003124317181"))
