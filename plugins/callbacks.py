        ...
        if data == "home":
            await query.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup([
                    ...
                    [InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs', url='https://t.me/Anime_UpdatesAU'), InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ •', url='https://t.me/AU_Bot_Discussion')],
                    [InlineKeyboardButton('• ᴀʙᴏᴜᴛ', callback_data='about'), InlineKeyboardButton('Dᴇᴠᴇʟᴏᴘᴇʀ •', url='https://t.me/Mr_Mohammed_29')]
                ]
            )
        elif data == "caption":
            await query.message.edit_text(
            ...
            await query.message.edit_text(
                ...
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton("• ʙᴀᴄᴋ", callback_data="help"), InlineKeyboardButton("ᴏᴡɴᴇʀ •", url='https://t.me/Anime_UpdatesAU')]
                ])
            )
